    ...
    <>
      <style>{`
        ...
        @keyframes cssalientIn {
          from { opacity: 0; transform: translateY(-50%) scaleX(1.05); filter: blur(4px); }
          to   { opacity: 1; transform: translateY(-50%) scaleX(1); filter: blur(0px); }
        }
      ...
      <nav
        ...
        style={{
          ...
          justifyContent: menuOpen ? 'flex-end' : 'space-between',
          padding: '0 1.75rem',
